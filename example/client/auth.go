...
func (c *Client) RefreshAuth(ctx context.Context, path string, payload *app.RefreshAuthPayload) (*http.Response, error) {
	var body io.Reader
...
func (c *Client) TokenAuth(ctx context.Context, path string, payload *app.TokenAuthPayload) (*http.Response, error) {
	var body io.Reader
	b, err := json.Marshal(payload)
	if err != nil {
		return nil, fmt.Errorf("failed to serialize body: %s", err)
