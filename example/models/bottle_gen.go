...
func (m *Bottle) ToBottle() app.Bottle {
	...
	// Unknown conversion: vintage, Vintage
	// Unknown conversion: color, Color
	// Unknown conversion: name, Name
	payload.Region = &m.Region
	// Unknown conversion: vineyard, Vineyard
	// Unknown conversion: id, ID
	payload.Country = &m.Country
	payload.Sweetness = &m.Sweetness
	// Unknown conversion: varietal, Varietal
	return payload
}
